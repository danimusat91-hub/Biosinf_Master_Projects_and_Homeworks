...
############# Window and Test, Validation and Train ################################

## Training set
Data_process_Object = processData(X[0:180],Y[0:180],Fs,Overlapping,Window_Size)
...
## Validation set
Data_process_Object = processData(X[180:240],Y[180:240],Fs,Overlapping,Window_Size)
...
## Validation set
Data_process_Object = processData(X[240:303],Y[240:303],Fs,Overlapping,Window_Size)
